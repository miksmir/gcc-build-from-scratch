...
## Usage
This is clearly meant for Linux for obvious reasons, but I am sure you can get the shell script to work on Windows/Mac too. Aside from the path to bash in the script's shebang line, there should not be any issues with portability.
